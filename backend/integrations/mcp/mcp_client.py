...
class MCPClient(LoggerMixin):
    ...
    async def start_server(self, server_name: str) -> bool:
        ...
        try:
            ...
            self.log_info(f"MCP server started: {server_name}", pid=process.pid)
        ...
        try:
            ...
            response = await self._send_request(
                ...
                "initialize",
                {
                    ...
                    "capabilities": {},
                    "clientInfo": {"name": "omnipath", "version": "5.0.0"},
                },
            )
    ...
    async def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Any:
        ...
        self.log_info(f"Calling tool: {tool}", server=server_name, arguments=arguments)
        ...
        try:
            ...
            self.log_info(f"Tool call completed: {tool}", server=server_name)
    ...
    async def get_prompt(
        ...
        self.log_debug(f"Getting prompt: {prompt}", server=server_name)
        ...
        try:
            ...
            response = await self._send_request(
                server_name,
                "prompts/get",
                {"name": prompt, "arguments": arguments or {}},
            )
    ...
    async def read_resource(self, resource_uri: str) -> str:
        ...
        self.log_debug(f"Reading resource: {uri}", server=server_name)
